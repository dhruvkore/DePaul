 ...
 * 
 */
@WebServiceClient(name = "QuoteServiceService", targetNamespace = "http://Quotes/", wsdlLocation = "http://localhost:8888/quotes?wsdl")
    ...
    extends Service
{
    ...
    private final static QName QUOTESERVICESERVICE_QNAME = new QName("http://Quotes/", "QuoteServiceService");
    ...
    public QuoteService getQuoteServicePort() {
        return super.getPort(new QName("http://Quotes/", "QuoteServicePort"), QuoteService.class);
    }
    ...
    public QuoteService getQuoteServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Quotes/", "QuoteServicePort"), QuoteService.class, features);
    }
